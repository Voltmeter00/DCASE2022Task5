...
def training_transductive_model(conf=None, hdf_eval=None, device=None, strt_index_query=None, mean=None, std=None,
    ...
    print("Postive_size:{}".format(X_pos.size()))
    print("Negtive_size:{}".format(X_neg.size()))
    print("Query_size:{}".format(X_query.size()))
    ...
    for epoch in range(iterations):
        ...
        for batch in tqdm(q_iterator):
            ...
            pos_indices = torch.randperm(len(X_pos))[::conf.eval.samples_neg]
